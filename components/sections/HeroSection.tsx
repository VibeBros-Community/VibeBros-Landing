                        ...
                        >
                            ...
                            >
                                <a href="https://discord.gg/p6UWRMrj" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <svg className="mr-2 sm:mr-3 h-5 w-5 sm:h-6 sm:w-6 fill-current relative z-10" viewBox="0 0 127.14 96.36">
                                    ...
                                    <span className="relative z-10 whitespace-nowrap">Join Discord Server</span>
                                </a>
                            </Button>
                        </motion.div>
                    </motion.div>
